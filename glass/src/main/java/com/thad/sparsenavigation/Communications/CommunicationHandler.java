            ...
            public void run() {
                try {
                    ...
                    try {
                        ...
                        nameValuePairs.add(new BasicNameValuePair("phase", "1"));
                        nameValuePairs.add(new BasicNameValuePair("time", "1"));
                        nameValuePairs.add(new BasicNameValuePair("pathId", "1"));
                        nameValuePairs.add(new BasicNameValuePair("bookTag", "1"));
                        nameValuePairs.add(new BasicNameValuePair("device", "glass"));
                        nameValuePairs.add(new BasicNameValuePair("viewPosition", "na"));
