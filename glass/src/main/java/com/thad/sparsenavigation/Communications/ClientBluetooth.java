...
import com.thad.sparse_nav_lib.Communications.BluetoothListener;
import com.thad.sparse_nav_lib.Communications.CommThread;
...
public class ClientBluetooth implements BluetoothListener {
    ...
    private BluetoothListener.CONN_STATES state;
